...
class OpenShiftClient:
    ...
    def allocation_resources(self):
        return {
            ...
            "rolebinding": self.get_resource_api(
...
def create_allocation(
    name: str, spec: dict[str, Any], patch: kopf.Patch, **_: Any
) -> None:
...
def reconcile_allocation_periodically(
    name: str, spec: dict[str, Any], patch: kopf.Patch, **_: Any
) -> None:
    _reconcile(name, spec, patch)
...
def delete_allocation(name: str, spec: dict[str, Any], **_: Any) -> None:
    ...
    def safe_delete(
        resource_api_name: str, resource_name: str, object_name: str
    ) -> None:
